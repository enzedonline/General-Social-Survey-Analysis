...
```{r time_analysis_pt, fig.height=3.5, fig.width=9.5, cache=FALSE}
p
t
```
...
::: columns
::: {.column width="35%"}
```{r bp_crime, fig.height=2, fig.width=4}
bp_crime
```
:::
...
::: columns
::: {.column width="35%"}
```{r bp_class, fig.height=2, fig.width=4}
bp_class
```
:::
...
::: columns
::: {.column width="35%"}
```{r bp_se, fig.height=2, fig.width=4}
bp_se
```
:::
